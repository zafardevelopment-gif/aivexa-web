...
export const toolCategories: ToolCategoryDef[] = [
  {
    ...
    tools: [
      ...
      { slug: "hra-calculator", name: "HRA Calculator", description: "HRA exemption under Section 10(13A) — exempt vs taxable.", status: "live" },
      { slug: "salary-structure-optimizer", name: "Salary Structure Optimizer", description: "CTC breakup with old vs new tax regime comparison.", status: "live" },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "prayer-times", name: "Prayer Times", description: "Today's 5 daily prayer times for your city.", status: "live" },
      { slug: "qibla-direction", name: "Qibla Direction", description: "Find the Qibla direction from your location.", status: "live" },
      { slug: "ramadan-calendar", name: "Ramadan Calendar", description: "Sehri/Iftar timings for the Hijri Ramadan month.", status: "live" },
      { slug: "salah-time-reminder", name: "Salah Time Reminder", description: "Browser notifications for upcoming prayer times.", status: "live" },
    ],
  },
  {
    slug: "misc",
    ...
    tools: [
      ...
      { slug: "baby-name-generator", name: "Baby Name Generator", description: "Religion-wise names with meaning and gender filter.", status: "live" },
      { slug: "solar-system-explorer", name: "Solar System Explorer", description: "Interactive planets diagram with quick facts.", status: "live" },
      { slug: "aadhaar-masking-tool", name: "Aadhaar Masking Tool", description: "Mask the first 8 digits on an Aadhaar image.", status: "live" },
      { slug: "youtube-tag-generator", name: "YouTube Tag Generator", description: "SEO tags for your videos from real YouTube search suggestions.", status: "live" },
      { slug: "rental-roi-calculator", name: "Rental ROI Calculator", description: "Rental yield, total ROI and payback period for a property.", status: "live" },
      { slug: "society-maintenance-calculator", name: "Society Maintenance Split Calculator", description: "Divide society expenses per flat — equally or by sq.ft.", status: "live" },
      { slug: "pan-aadhaar-name-matcher", name: "PAN-Aadhaar Name Matcher", description: "Similarity score and fix suggestions for name mismatches.", status: "live" },
      { slug: "certificate-qr-generator", name: "Certificate QR Generator", description: "Verification QR code PNG for certificates.", status: "live" },
    ],
  },
  {
    slug: "pdf",
  ...
  },
  {
    ...
    tools: [
      { slug: "cv-resume-builder", name: "CV/Resume Builder", description: "Form-based resume builder with ATS-friendly template.", status: "live" },
      { slug: "marriage-biodata-maker", name: "Marriage Biodata Maker", description: "Indian-style matrimonial biodata PDF.", status: "live" },
      { slug: "cover-letter-generator", name: "Cover Letter Generator", description: "Structured cover letter draft generator.", status: "live" },
      { slug: "invoice-generator", name: "Invoice Generator", description: "Business invoice with auto-calculated totals.", status: "live" },
      { slug: "salary-slip-generator", name: "Salary Slip Generator", description: "Payslip with earnings/deductions breakdown.", status: "live" },
      { slug: "rent-receipt-generator", name: "Rent Receipt Generator", description: "Monthly rent receipts for HRA proof.", status: "live" },
      { slug: "offer-letter-generator", name: "Offer Letter Generator", description: "Employee offer letter template.", status: "live" },
      { slug: "noc-letter-generator", name: "NOC Letter Generator", description: "No-objection certificate templates.", status: "live" },
      { slug: "certificate-maker", name: "Certificate Maker", description: "Completion/participation certificate templates.", status: "live" },
      { slug: "id-card-maker", name: "ID Card Maker", description: "Employee/student ID card template.", status: "live" },
      { slug: "visiting-card-maker", name: "Visiting Card Maker", description: "Business card designer, print-ready PDF.", status: "live" },
      { slug: "letterhead-maker", name: "Letterhead Maker", description: "Company letterhead generator.", status: "live" },
      { slug: "signature-generator", name: "Signature Generator", description: "Typed or drawn signature as a transparent PNG.", status: "live" },
      { slug: "invitation-card-maker", name: "Invitation Card Maker", description: "Wedding/birthday/event invitation templates.", status: "live" },
